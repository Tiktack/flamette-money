...
export const cashflowSeriesQueryOptions = (
...
export const categorySeriesQueryOptions = (
...
export const monthlyYoyQueryOptions = (
...
export const portfolioBalanceSeriesQueryOptions = (
