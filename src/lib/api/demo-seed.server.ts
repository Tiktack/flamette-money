...
import type { SeedDemoResponse } from "@/lib/api/generated/types.gen"
...
function getAccountDefinitions(): AccountDefinition[] {
  return [
    { name: "Cash PLN", description: "Local cash for daily spending.", currency: "PLN", color: "#2F9E44", icon: "IconCash", type: "Cash", currentBalance: 1200 },
    { name: "Cash EUR", description: "Travel cash reserved in euros.", currency: "EUR", color: "#0B7285", icon: "IconCash", type: "Cash", currentBalance: 400 },
    { name: "Card PLN", description: "Primary debit card for domestic purchases.", currency: "PLN", color: "#1971C2", icon: "IconCreditCard", type: "DebitCard", currentBalance: 3500 },
    { name: "Card EUR", description: "Secondary debit card for euro expenses.", currency: "EUR", color: "#364FC7", icon: "IconCreditCard", type: "DebitCard", currentBalance: 800 },
    { name: "Revolut Card", description: "Flexible travel card with multi-currency balance.", currency: "EUR", color: "#7048E8", icon: "IconWallet", type: "DebitCard", currentBalance: 1600 },
  ]
}
...
function buildTripDefinitions(startDate: Date, endDate: Date) {
  const allDefinitions: TripSeedDefinition[] = [
    { name: "Paris, France", startDate: new Date("2022-06-10T00:00:00.000Z"), endDate: new Date("2022-06-19T00:00:00.000Z"), imageUrl: "https://tse3.mm.bing.net/th/id/OIP.6Yrhn7ORfVo_4tS4VaSPxQHaEo?rs=1&pid=ImgDetMain&o=7&rm=3", country: "FR" },
    { name: "Berlin, Germany", startDate: new Date("2022-10-03T00:00:00.000Z"), endDate: new Date("2022-10-09T00:00:00.000Z"), imageUrl: "https://th.bing.com/th/id/OIP.t6dxttYixG86lZzVESWdygHaEK?w=286&h=180&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3", country: "DE" },
    { name: "London, United Kingdom", startDate: new Date("2023-03-15T00:00:00.000Z"), endDate: new Date("2023-03-20T00:00:00.000Z"), imageUrl: "https://th.bing.com/th/id/OIP.mPLXOEAwULJlqrItJA0j2gHaFj?w=226&h=180&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3", country: "GB" },
    { name: "Lisbon, Portugal", startDate: new Date("2023-08-05T00:00:00.000Z"), endDate: new Date("2023-08-16T00:00:00.000Z"), imageUrl: "https://th.bing.com/th/id/R.8838157e1c8a414875b906139e026bb2?rik=IFMzsIMBmauv8w&pid=ImgRaw&r=0", country: "PT" },
    { name: "Nice, France", startDate: new Date("2024-05-20T00:00:00.000Z"), endDate: new Date("2024-05-28T00:00:00.000Z"), imageUrl: "https://tse3.mm.bing.net/th/id/OIP.6Yrhn7ORfVo_4tS4VaSPxQHaEo?rs=1&pid=ImgDetMain&o=7&rm=3", country: "FR" },
    { name: "Munich, Germany", startDate: new Date("2024-09-20T00:00:00.000Z"), endDate: new Date("2024-09-26T00:00:00.000Z"), imageUrl: "https://th.bing.com/th/id/OIP.t6dxttYixG86lZzVESWdygHaEK?w=286&h=180&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3", country: "DE" },
    { name: "Edinburgh, United Kingdom", startDate: new Date("2025-04-10T00:00:00.000Z"), endDate: new Date("2025-04-15T00:00:00.000Z"), imageUrl: "https://th.bing.com/th/id/OIP.mPLXOEAwULJlqrItJA0j2gHaFj?w=226&h=180&c=7&r=0&o=7&dpr=1.5&pid=1.7&rm=3", country: "GB" },
    { name: "Porto, Portugal", startDate: new Date("2025-07-02T00:00:00.000Z"), endDate: new Date("2025-07-12T00:00:00.000Z"), imageUrl: "https://th.bing.com/th/id/R.8838157e1c8a414875b906139e026bb2?rik=IFMzsIMBmauv8w&pid=ImgRaw&r=0", country: "PT" },
  ]
...
export async function handleSeedDemoRequest(request: Request) {
  ...
  const travelParentIds = new Set(
    expenseCategories
      .filter((category) => category.parentId === null && category.name.trim().toLowerCase() === "travel")
  ...
  for (const definition of buildTripDefinitions(startDate, endDate)) {
    ...
    newTrips.push(trip)
    tripWindows.push({ id: trip.id, startDate: definition.startDate, endDate: definition.endDate })
  }
  ...
  for (let date = new Date(startDate); date <= endDate; date = new Date(date.getTime() + 24 * 60 * 60 * 1000)) {
    ...
    for (let index = 0; index < count; index++) {
      ...
      const expenseChild = expenseParent && random.next() < 0.6
        ? pickValue(random, expenseChildrenByParent.get(expenseParent.id) ?? [])
        : null
